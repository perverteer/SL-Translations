...
translate russian strings:
    ...
    new "горизонтальное прокручивание"

    # renpy/common/00accessibility.rpy:36
    old "vertical scroll"
    new "вертикальное прокручивание"
    ...
    new "Снижение громкости голоса"

    # renpy/common/00accessibility.rpy:202
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Параметры этого меню предназначены для повышения доступности. Они могут работать не со всеми играми, а некоторые комбинации параметров могут сделать игру неиграбельной. Это не проблема игры или движка. Для достижения наилучших результатов при смене шрифтов старайтесь сохранить размер текста таким же, как и был изначально."
    ...
    new "Сохранить в %s: [text]"

    # renpy/common/00action_file.rpy:434
    old "Load slot %s: [text]"
    new "Загрузить %s: [text]"
    ...
    new "Загрузка этого сохранение приведет к потере прогресса. \nВы уверены, что хотите сделать это?"
    ...
    new "Ошибка сохранения скриншота %s."

    # renpy/common/00keymap.rpy:312
    old "Saved screenshot as %s."
    new "Скриншот сохранен %s"
    ...
    new "Эта программа содержит бесплатное программное обеспечение по ряду лицензий, включая Лицензию MIT и Стандартную общественную лицензию ограниченного применения GNU. Полный список программного обеспечения, включая ссылки на полный исходный код, можно найти {a=https: //www.renpy.org/l/license}здесь{/a}."
    ...
    old "self voicing"
    new "автоматическая озвучка"

    # renpy/common/00preferences.rpy:388
    old "self voicing volume drop"
    new "снизить громкость автоозвучки"
    ...
    new "Озвучка в буфер включена. Нажмите 'shift+C' чтобы отключить."

    # renpy/common/00preferences.rpy:573
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "Автоозвучивание сказало бы \"[renpy.display.tts.last]\". Нажмите 'alt+shift+V', чтобы отключить."

    # renpy/common/00preferences.rpy:575
    old "Self-voicing enabled. Press 'v' to disable."
    new "Автоозвучивание включено. Нажмите 'v', чтобы отключить."
    ...
    new "Обновление Ren'Py не поддерживается мобильными устройствами."
    ...
    new "У этой учетной записи нет разрешения на обновление."
    ...
    new "В файле обновления нет правильного дайджеста - возможно, он поврежден."
    ...
    new "Загружена последняя версия."
    ...
    new "Обновления были установлены. Программа будет перезагружена."
    ...
    new "Графические драйверы могут быть устаревшими или работать неправильно. Это может привести к медленному или неправильному отображению графики."
    ...
    new "Открытие файла traceback.txt в текстовом редакторе."
    ...
    new "Пытается вернуться к предыдущему времени, позволяя сохранить или выбрать другой вариант."
    ...
    new "Не удалось проанализировать сценарий."
    ...
    new "Копирует файл errors.txt в буфер обмена как BBcode для форумов, таких как https://lemmasoft.renai.us/."
...
# renpy/common/00sync.rpy:70
    ...
    old "Sync Error"
    # Automatic translation.
    new "Ошибка синхронизации"# TODO: Translation updated at 2023-07-17 16:27
