...
translate french day16_choices_b0459485:
    ...
    "{i}Vous vous réveillez dans une chambre vide, [r_name] est déjà partie, probablement pour s'habiller et se préparer pour la journée. Vous sortez en douce de sa chambre et ne croisez personne dans le couloir."

# game/day16.rpy:38
translate french day16_choices_939019a7:
    ...
    "{i}En allant prendre une douche, vous passez devant la chambre [m_name] qui dort profondément au sons du sifflement que vous écoutez, elle a dû s’endormir tard aussi."

# game/day16.rpy:39
translate french day16_choices_4320d162:

    # "{i}When you enter the living room, a bikini-clad [m_name] is sitting on the couch watching television."
    "{i}Après avoir pris une douche vous allez dans le salon. Vous trouvez [m_name] vêtu d'un bikini assise dans le canapé entrains de regarder la télévision."
...
translate french day16_choices_2003a1af:
    ...
    m "Tes soeurs sont déjà parties à la plage."

# game/day16.rpy:45
translate french day16_choices_c97f59d8:

    # m "The girls are already at the beach."
    m "Les filles sont déjà parties à la plage."
...
translate french day16_choices_e9b4f560:
    ...
    "{i}Vous vous faites un sandwich et vous vous asseyez à côté de votre mère."

# game/day16.rpy:52
translate french day16_choices_b1982764:

    # "{i}You make yourself a sandwich and have a seat next to Mrs. Smith."
    "{i}Vous vous faites un sandwich et vous vous asseyez à côté de Mme Smith."
...
translate french day16_choices_980a5324:
    ...
    man "... ne spéculerait pas sur une interdiction pure et simple du contenu pour adultes, mais il est de la notoriété publique que ces mesures bénéficient d'un large appui politique."
...
translate french day16_choices_c29c8d82:
    ...
    p "Tout cela semble bien beau, l'accent mis sur les valeurs familiales et la restauration de la nation, mais en dessous de tout cela... Ça pue la censure, non ?"
...
translate french day16_choices_f98d8829:
    ...
    p "Ce truc te dérange vraiment, non ?"
...
translate french day16_choices_a3acdd7c:
    ...
    m "Je vais me baigner dans le mer pour me rafraîchir."
...
translate french day16_choices_25b083e4:
    ...
    p "{i}(Heureusement que j'ai apporté mon ordinateur portable, sinon j'aurais pu manquer un e-mail super important.)"
...
translate french day16_choices_0fd30849:
    ...
    "{i}Après avoir pris quelques précautions pour cacher votre identité, vous téléchargez la vidéo de Brody sur un site de partage de fichiers anonyme et vous écrivez un e-mail."
...
translate french day16_choices_4135b175:
    ...
    p "{i}Chère Monsieur, Madame, vous trouverez ci-joint des images filmées par une caméra de sécurité dans un de vos magasins. L'homme en question est un de vos employés qui se livre à des activités illicites avec ce que nous pensons être une prostituée, pendant les heures de travail."
...
translate french day16_choices_77bc389f:
    ...
    p "{i}Nous sommes presque certains que ce n'est pas le genre de comportement que votre entreprise tolère ou promeut et j'espère que vous prendrez les mesures appropriées afin de vous assurer que cela ne se reproduise pas à l'avenir. Vôtre sincèrement, un citoyen consterné."

# game/day16.rpy:100
translate french day16_choices_318f66d0:

    # p "Normally I'd hate ratting someone out, but this is Brody we're talking about."
    p "Normalement, je déteste dénoncer quelqu'un, mais c'est de Brody qu'on parle."
...
translate french day16_choices_2a0f1aaa:
    ...
    p "{i}Tu vas arrêter le chantage, sinon je publierai ces photos comme bon me semble. J'ai joint quelques photos pour que tu en profites et que tu saches que je ne suis pas en train de dire des conneries."
...
translate french day16_choices_9e1bd8ed:
    ...
    p "{i}Tu vas arrêter le chantage, sinon je publierai cette vidéo comme bon me semble. J'ai joint un extrait pour que tu puisses en profiter et que tu saches que je ne suis pas en train de dire des conneries."
...
translate french day16_choices_df6f14b6:
    ...
    "{i}[r_name] veut clairement avoir une conversation privée elle vous emmène dans un endroit plus isolé sur la plage, éloignée de [l_name] et [b_name]."
...
translate french day16_choices_64bae5bd:
    ...
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de votre soeur. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."
...
translate french day16_choices_531714ef:
    ...
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de [r_name]. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."
...
translate french day16_choices_a1dc4e8f:
    ...
    p "Comment as-tu pu penser une telle chose, [r_name] ! Tu es la fille la plus merveilleuse et la plus gentille que j'ai jamais rencontrée !"
...
translate french day16_choices_64bae5bd_1:
    ...
    # "{i}Your kiss is long and passionate and nearly takes your sister's breath away. Though you are in a secluded spot, anybody could see you, but you both clearly don't care about that."
    "{i}Votre baiser est long et passionné et il coupe le souffle à votre soeur. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:213
translate french day16_choices_531714ef_1:

    # "{i}Your kiss is long and passionate and nearly takes [r_name]'s breath away. Though you are in a secluded spot, anybody could see you, but you both clearly don't care about that."
    "{i}Votre baiser est long et passionné et il coupe le souffle à [r_name]. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."
...
translate french day16_choices_a780bbca:
    ...
    "{i}[r_name] sanglote de façon incontrôlable quand vous la laissez et que vous retournez vers [l_name] et [b_name]."
...
translate french day16_choices_5456b363:
    ...
    "{i}[r_name] et [l_name] ont une conversation animée quand vous vous approchez de [b_name]."
...
translate french day16_choices_bc5139ac:
    ...
    b "Tu me veux pour toi tout seul, n'est-ce pas ?"
...
translate french day16_choices_37d89ce2:
    ...
    n "Prêt à te plonger dans la culture Belugienne ?"
...
translate french day16_choices_c5677c96:
    ...
    p "Ouai, j'en ai entendu parler. Mais est-il vrai qu'il a épousé certaines de ses soeurs et cousines ?"
...
translate french day16_choices_01c44ce7:
    ...
    n "Ouai. L'important, c'est qu'ils se sont mariés, ses femmes n'étaient pas obligées de faire quoi que ce soit."
...
translate french day16_choices_955b2bd6:
    ...
    n "Si tu aimes beaucoup quelqu'un et qu'il ou elle t'aime en retour, pourquoi ne pas profiter l'un de l'autre ? Quel mal y a-t-il là-dedans ? Tant que les deux sont des adultes consentants, je ne vois pas le problème."

# game/day16.rpy:299
translate french day16_choices_594f287e:

    # p "{i}(I really get what she's saying.)"
    p "{i}(Je comprends ce qu'elle dit.)"
...
translate french day16_choices_566897fe:
    ...
    p "{i}(Ça doit être l'effet de toutes ces statues copulant, mais bon sang, cette fille a un petit cul si tonique. J'aimerais bien me cacher le visage entre ces belles joues.)"
...
translate french day16_choices_5fe1bc41:
    ...
    p "Ça vient du faite de regarder un tas de porno."
...
translate french day16_choices_4fadfc8c:
    ...
    p "Ou de l'effet de levier de l'organe reproducteur masculin."
...
translate french day16_choices_8445b88f:
    ...
    "{i}Nia fait signe à quelqu'un derrière votre dos."
...
translate french day16_choices_d5c8bbbe:
    ...
    n "Au faite, pourquoi es-tu ici Rebeca ?"
...
translate french day16_choices_f41bc56a:
    ...
    rb "L'exposition ouvre officiellement ses portes ce soir. Je dois supporter toutes ces conneries sociales. Je déteste être un singe de scène. J'ajustais juste quelques trucs pour l'ouverture."
...
translate french day16_choices_3b0ad58d:
    ...
    n "Il y a des toilettes quelque part ? J'ai vraiment besoin d'aller pisser."
...
translate french day16_choices_1e72f347:
    ...
    p "Belugio est île magnifique. C'est vraiment un paradis."
...
translate french day16_choices_9a38244e:
    ...
    p "{i}(Cette lueur dans ses yeux... Est-elle vraiment intéressée à parler ?)"
...
translate french day16_choices_82742e19:
    ...
    rb "Merci, je crois que j'en ai bien besoin."
...
translate french day16_choices_f6802e61:
    ...
    n "Je lui parlerai plus tard alors. Dit moi, tu as aimé ma mère ?"

# game/day16.rpy:422
translate french day16_choices_e86c7321:

    # p "That... That was your mother?"
    p "Qu... C'était ta mère ?"
...
translate french day16_choices_f1cb28e0:
    ...
    n "Bien ! Rentrons, je rejoins ta soeur dans une heure."
...
translate french day16_choices_870507e0:
    ...
    p "J'aimerais pouvoir venir avec vous."
...
translate french day16_choices_12de84b4:
    ...
    p "D'accord. Merci de m'avoir emmené."

# game/day16.rpy:450
translate french day16_choices_f8570a5a:

    # n "My pleasure!"
    n "Tout le plaisir était pour moi !"
...
translate french day16_choices_0555c11a:
    ...
    "{i}Quand vous marchez jusqu'à l'adresse que Rebeca vous as donnée, elle vous attend dehors."
...
translate french day16_choices_fba8cac7:
    ...
    rb "Tu as une minute ? J'ai vraiment besoin d'aller pisser."
...
translate french day16_choices_5d46f5fd:
    ...
    "{i}Vous faites attention à ne pas vous faire prendre et vous suivez Rebeca jusqu'à un endroit isolé entre plusieurs gros rochers. Quand vous arrivez, elle est déjà déshabillée..."
...
translate french day16_choices_0b252137:
    ...
    "{i}Vous retournez à la plage et vous attendez le retour de Rebeca."

# game/day16.rpy:494
translate french day16_choices_4992d2b8:

    # rb "Guess who I saw just now..."
    rb "Devine qui j'ai vue tout à l'heure..."
...
translate french day16_choices_73d7233c:
    ...
    p "Merci, le sentiment est tout aussi réciproque."
...
translate french day16_choices_357c561f:
    ...
    "{i}Très vite, vous arrivez à l'endroit où vous avez rencontrer Rebeca avant votre petite promenade. Elle ouvre la porte et vous entrez."
...
translate french day16_choices_63123add:
    ...
    "{i}La vue de son corps nue ne fait rien pour soulager la chaleur au contraire sa vous fait bander à la place."
...
translate french day16_choices_e16945e4:
    ...
    rb "Wow, tu es le spécimen parfait pour mon premier exemplaire. Peut-être que je te coulerai dans du bronze ou dans un autre métal précieux... je ne sais pas. Mais tu seras la fière introduction de ma nouvelle série d'oeuvres d'art."
...
translate french day16_choices_4aa8d273:
    ...
    "{i}Vous vous allongez et vous fermez les yeux pendant que Rebeca fouille dans son studio pour trouver son matériel."
...
translate french day16_choices_283155d8:
    ...
    "{i}Vous avez dû vous assoupir un moment car vous vous réveillez choqué quand vous sentez des mains froides toucher votre pénis."
...
translate french day16_choices_5baf947e:
    ...
    "{i}Quand Rebeca est satisfaite, elle arrête soudainement de masser votre bite et sort quelques outils, probablement pour faire le moule. Vous recommencez à somnoler à cause de la chaleur."
...
translate french day16_choices_91255c4e:
    ...
    "{i}Presque inconsciemment, vous ressentez un liquide épais et froid se répandre sur votre entrejambe, qui durcit rapidement. Rebeca siffle un air stupide pendant qu'elle travaille."
...
translate french day16_choices_f4b65e6d:
    ...
    "{i}Au bout d'un moment, le moule est enlevé et Rebeca vous frotte la bite avec une serviette douce bien plus longtemps que nécessaire."
...
translate french day16_choices_b625aa51:
    ...
    p "T'es en train de m'exciter , tu sais ça ?"
...
translate french day16_choices_2f090249:
    ...
    "{i}Rebeca n'hésite pas et se dirige vers vous. Soudainement vous êtes pris dans un baiser passionné, ses mains explorant votre corps et les vôtres pétrisses fermement ses seins."
...
translate french day16_choices_5bdc47d5:
    ...
    "{i}Quand vous entres enfin en elle, elle est déjà mouillée. Vous la pénétrez profondément et vous établissez rapidement un rythme."
...
translate french day16_choices_e5fe96eb:
    ...
    "{i}Encouragée par ses paroles, vous la pilonnez encore plus fort. Le studio est rempli des sons humides de votre accouplement et des gémissements rauques de Rebeca."
...
translate french day16_choices_f6e1277b:
    ...
    "{i}Quand vous changez de position, le cul de Rebeca rebondit contre votre bassin et vous le giflez à plusieurs reprises."

# game/day16.rpy:563
translate french day16_choices_c064ca31:

    # rb "Mmmmm yeah, slap it."
    rb "Mmmmmmm ouai, claque le."
...
translate french day16_choices_27a51b38:
    ...
    "{i}Vous vous retirez et Rebeca s'agenouille rapidement devant vous, sa bouche impatiente s'ouvre pour recevoir votre semence chaude."
...
translate french day16_choices_ddae8c90:
    ...
    "{i}Des jets épais de sperme jaillissent de votre bite. Rebeca essaie de tout attraper dans sa bouche, mais une partie lui atterrie sur visage."

# game/day16.rpy:574
translate french day16_choices_eb00dfd3:

    # "{i}She closes her mouth and swallows your entire load, licking her lips afterwards."
    "{i}Elle ferme sa bouche et avale tout votre lait, se léchant les lèvres de délectation."
...
translate french day16_choices_785a830f:
    ...
    "{i}Vous êtes tous les deux en sueur et épuisés par la chaleur du studio de Rebeca. L'air sent le sexe et le sperme."
...
translate french day16_choices_207ca936:
    ...
    "{i}Rebeca enfonce un doigt dans sa chatte et le lèche recouvert de votre sperme avec délectation."
...
translate french day16_choices_1c2207a8:
    ...
    "{i}Quand vous reprenez votre souffle, vous laissez Rebeca dans son studio et vous retournez à l'appartement."

# game/day16.rpy:599
translate french day16_choices_75c6b48c:

    # p "Sorry, no. That's about the craziest thing I've ever heard."
    p "Désolée, non. C'est la chose la plus folle que j'ai jamais entendue."
...
translate french day16_choices_c29c8bfe:
    ...
    "{i}Vous accélérez le pas pour vous éloigner de Rebeca et bientôt elle est hors de vue."

# game/day16.rpy:609
translate french day16_choices_0eb25971:

    # p "{i}(That was an interesting day. Wonder what the evening will bring.)"
    p "{i}(C'était une journée intéressante. Je me demande ce que la soirée nous réservera.)"
...
translate french day16_choices_9a0ebe13:
    ...
    "{i}Vous traînez autour de l'appartement et de la plage, à reluquer les femmes en bikini, jusqu'au soir."
...
translate french day16_evening_choices_67704916:
    ...
    b "Quelque chose ne va pas, frérot ?"
...
translate french day16_evening_choices_b58f428f:
    ...
    "{i}Après une courte marche, vous arrivez au restaurant que vous avez réservé."
...
translate french day16_evening_choices_d6f1191f:
    ...
    p "C'est censé être un endroit chic. Détends-toi et savoure le repas."
...
translate french day16_evening_choices_058e8959:
    ...
    "{i}Une bosse reste coincée dans votre gorge quand [b_name] vous touche affectueusement la main. Le regard de votre soeur va bien au-delà de l'affection familiale, c'est plus un désir d'adoration."
...
translate french day16_evening_choices_33ff551d:
    ...
    "{i}Une bosse reste coincée dans votre gorge quand [b_name] vous touche affectueusement la main. Le regard dans ses yeux va au-delà de l'affection amicale, c'est plus un désir d'adoration."
...
translate french day16_b_restaurant_choices_soft_b9d186c0:
    ...
    b "Ouai, l'argent est moins nécessaire maintenant, grâce à toi. Donc je serai plus là pour t'ennuyer."
...
translate french day16_b_restaurant_choices_soft_2b08204b:
    ...
    b "Merde. D'accord. Chaque fois que je pense à lui, j'ai encore un soupçon de ces sentiments palpitants. Donc oui, je suppose que c'était l'amour, le grand amour."
...
translate french day16_b_restaurant_choices_soft_c7c3d03e:
    ...
    "{i}Vous vous regardez dans les yeux après le baiser affectueux de [b_name] sur votre joue."
...
translate french day16_b_restaurant_choices_soft_13116f38:
    ...
    "{i}Soudainement vous la serrez fort, ses seins pressés contre votre torse. Le baiser qui suit est passionné et alimenté par un désir animaliste d'être proche l'un de l'autre."
...
translate french day16_b_restaurant_choices_soft_ebcc3197:
    ...
    "{i}[b_name] respire profondément et semble avoir complètement oublié son environnement. Vous sentez les courbes lisses de son corps sous vos mains. L'odeur de son parfum est exaltante."

# game/day16.rpy:815
translate french day16_b_restaurant_choices_soft_94eb89ef:

    # b "Fuck! What are we doing?!"
    b "Merde ! Qu'est-ce qu'on fait ?!"
...
translate french day16_b_restaurant_choices_soft_4f84ff92:
    ...
    "{i}Sans avoir fini sa phrase, votre soeur quitte précipitamment le restaurant."
...
translate french day16_b_restaurant_choices_soft_ffd6d6e2:
    ...
    p "{i}(Merde. Qu'est-ce qui s'est passé, on est allés trop vite ? Elle semblait vraiment prête à se soumettre complètement.)"
...
translate french day16_b_restaurant_choices_soft_4cc32f5d:
    ...
    "{i}Votre soeur se recouvre vite et finit son repas comme si rien ne s'était passé pendant que le serveur passes."
...
translate french day16_b_restaurant_choices_soft_532cc142:
    ...
    "{i}[b_name] se recouvre vite et finit son repas comme si rien ne s'était passé pendant que le serveur passes."
...
translate french day16_b_restaurant_choices_soft_e3a50e2b:
    ...
    "{i}Après avoir fini votre repas avec un dessert léger, vous retournez à l'appartement."
...
translate french day16_b_restaurant_choices_soft_c4a42b81:
    ...
    "{i}[l_name] se tait après cet échange. Parfois, on dirait qu'elle essaie de dire quelque chose, mais qu'elle préfère y réfléchir."
...
translate french day16_b_restaurant_choices_soft_8df2348b:
    ...
    "{i}Votre main est sur son ventre nue, votre soeur respire profondément tout en vous regardant d'impatience."
...
translate french day16_b_restaurant_choices_soft_65757b42:
    ...
    "{i}Vote main est sur son ventre nue et [l_name] respire profondément, en vous regardant d'impatience."

# game/day16.rpy:986
translate french day16_b_restaurant_choices_soft_0df3a880:

    # "{i}You take one of her hands and slowly move it towards her sex."
    "{i}Vous prenez une de ses mains et vous la déplacez lentement vers son sexe."
...
translate french day16_b_restaurant_choices_soft_e746ddcb:
    ...
    "{i}[l_name] fait docilement ce que vous dites, mais elle a toujours l'air mal à l'aise."
...
translate french day16_b_restaurant_choices_soft_7f1370a3:
    ...
    "{i}Vous vous rapprochez et vous lui chuchotez à voix basse."
...
translate french day16_b_restaurant_choices_soft_cc354b51:
    ...
    "{i}Peu de temps après, les doux gémissements de plaisir de [l_name] ralentissent et s'arrêtent complètement. Elle ne prend plus de plaisir et semble être revenue à un travail mécanique sans émotion."
...
translate french day16_b_restaurant_choices_soft_2c69ebf2:
    ...
    "{i}Votre soeur est à nouveau très concentrée, son comportement mécanique a complètement disparu. Elle se tortille dans le sable toute en se caressant la chatte."
...
translate french day16_b_restaurant_choices_soft_22032ab9:
    ...
    "{i}[l_name] est à nouveau très concentrée, son comportement mécanique a complètement disparu. Elle se tortille dans le sable toute en se caressant la chatte."
...
translate french day16_b_restaurant_choices_soft_a3b3282c:
    ...
    p "Après tous ces baisers, je retournerais à tes tétons et je les lécherais en te taquinant pendant que tu te doigtes. Quand tu approcheras de l'orgasme, je les sucerais, je t'enverrais au bord et te ferais jouir si fort."
...
translate french day16_b_restaurant_choices_soft_5f782092:
    ...
    "{i}Incapable d'en dire plus, votre soeur tremble violemment. Les vagues de son orgasme l'emportent sur toutes les autres fonctions musculaires de son corps."
...
translate french day16_b_restaurant_choices_soft_5ad0e16a:
    ...
    "{i}Incapable d'en dire plus, [l_name] tremble violemment. Les vagues de son orgasme l'emportent sur toutes les autres fonctions musculaires de son corps."
...
translate french day16_b_restaurant_choices_soft_9d5e58b7:
    ...
    "{i}Il faut du temps à [l_name] pour se remettre de son orgasme et elle semble incapable de parler pendant un certain temps."
...
translate french day16_b_restaurant_choices_soft_c826d305:
    ...
    l "Il fait un peu froid dans les dunes et j'ai soudainement sommeil."
...
translate french day16_b_restaurant_choices_soft_f951f29f:
    ...
    l "Merci pour cette charmante soirée. C'était vraiment important pour moi."
...
translate french day16_b_restaurant_choices_soft_e72ad31e:
    ...
    "{i}Vous continuez à marcher en silence et au bout d'un moment, [l_name] se mets à frissonner."
...
# game/day16.rpy:114
translate french day16_choices_34964c96:
    ...
    p "{i}Deuxièmement, j'ai cette vidéo très intéressante de ta mère et il semble qu'elle aime vraiment se faire baiser. C'est une merveilleuse pute et elle avoue même en être une sur la vidéo !"

# game/day16.rpy:117
translate french day16_choices_de931a9f:
    ...
    p "{i}Deuxièmement, j'ai cette vidéo très intéressante de ta mère et il semble qu'elle aime vraiment se faire baiser par une grosse bite noire. C'est une merveilleuse pute et elle avoue même en être une sur la vidéo !"

# game/day16.rpy:1056
translate french day16_b_restaurant_choices_soft_b00e3678:
...
# game/day16.rpy:199
translate french day16_choices_a2f20f31:
...
# game/day16.rpy:644
translate french day16_evening_choices_be530604:

    # b "I said I wasn't ready yet."
    b "J’ai dit que je n’étais pas encore prête."

# game/day16.rpy:900
translate french day16_b_restaurant_choices_soft_a5434a73:

    # b "I've done enough. Calling uncle on that."
    b "J'en ai assez. Je t’appellerais pas 'Pouce-pouce' pour ça."

# TODO: Translation updated at 2019-09-27 20:55

# game/day16.rpy:532
translate french day16_choices_33c8101d:
...
# game/day16.rpy:474
translate french day16_choices_7511b700:
...
# game/day16.rpy:159
translate french day16_choices_bf217f20:
    ...
    r "Et notre conversation d'hier m'a vraiment aidée à reprendre confiance en moi. Je ne vais pas gâcher ma vie pour une stupide conseillère universitaire. Je dois faire confiance en mes sentiments."

# game/day16.rpy:185
translate french day16_choices_14db33c9:

    # r "Fine, it was Mrs. Steel, the college counsellor. She called me and said some harsh things."
    r "C'était Mme Steel, la conseillère universitaire. Elle m'a appelé et m'a dit des choses cruelles."
# TODO: Translation updated at 2020-09-02 11:22

# game/day16.rpy:77
translate french day16_choices_76ba2f56:

    # p "It all sounds nice enough, the focus on family values and restoring the nation, but underneath it all... It reeks of censorship, doesn't it?"
    p "Tout cela semble bien beau, l'accent mis sur les valeurs familiales et la restauration de la nation, mais en dessous de tout cela... Ça pue la censure, non ?"

# game/day16.rpy:159
translate french day16_choices_542fef37:
...
# game/day16.rpy:185
translate french day16_choices_85a59f6b:
...
# game/day16.rpy:98
translate french day16_choices_eeb4569b:
    ...
    p "{i}Cher monsieur, chère madame, Vous trouverez ci-joint des images filmées par une caméra de sécurité dans l'un de vos magasins. L'homme en question est un de vos employés, qui s'adonne à des activités illicites pendant les heures de travail avec ce que nous pensons être une prostituée."

# game/day16.rpy:112
translate french day16_choices_73ec5022:
    ...
    p "{i}Vous allez donc arrêter le chantage. Sinon, je publierai ces photos comme je l'entends. J'ai joint quelques-unes des photos pour que vous sachiez que je ne dis pas n'importe quoi."

# game/day16.rpy:115
translate french day16_choices_4956d3f3:

    # p "{i}So you're going to stop blackmailing. Otherwise, I'll release that video in any way I see fit. I've attached a snippet of the footage for you to enjoy and so you know I'm not talking out of my ass."
    p "{i}Tu vas arrêter le chantage, sinon je publierai cette vidéo comme bon me semble. J'ai joint un extrait pour que tu puisses en profiter et que tu saches que je ne suis pas en train de dire des conneries."

# game/day16.rpy:118
translate french day16_choices_4956d3f3_1:

    # p "{i}So you're going to stop blackmailing. Otherwise, I'll release that video in any way I see fit. I've attached a snippet of the footage for you to enjoy and so you know I'm not talking out of my ass."
    p "{i}Tu vas arrêter le chantage, sinon je publierai cette vidéo comme bon me semble. J'ai joint un extrait pour que tu puisses en profiter et que tu saches que je ne suis pas en train de dire des conneries."

# game/day16.rpy:167
translate french day16_choices_9d070ff1:

    # "{i}Your kiss is long and passionate and nearly takes your sister's breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de votre soeur. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:169
translate french day16_choices_209dc845:

    # "{i}Your kiss is long and passionate and nearly takes [r_name]'s breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de [r_name]. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:193
translate french day16_choices_ef4bf75b:
    ...
    r "Mais hier, dans l'océan, j'ai cru que nous avions eu un moment, mais il ne s'est rien passé. Et cela m'a fait douter encore plus de nous. Es-tu vraiment là pour moi ou ne suis-je qu'un jouet ?"

# game/day16.rpy:211
translate french day16_choices_9d070ff1_1:

    # "{i}Your kiss is long and passionate and nearly takes your sister's breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de votre soeur. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:213
translate french day16_choices_209dc845_1:

    # "{i}Your kiss is long and passionate and nearly takes [r_name]'s breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de [r_name]. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:224
translate french day16_choices_7600d340:

    # p "No really, I can't be with someone who's shaken by the first person who questions you. In a healthy relationship, you face those problems together."
    p "Non vraiment, je ne peux pas être avec quelqu'un qui est bouleversé par la première personne qui t'interroge. Dans une relation saine, tu fais face à ces problèmes ensemble."

# game/day16.rpy:242
translate french day16_choices_9d070ff1_2:

    # "{i}Your kiss is long and passionate and nearly takes your sister's breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de votre soeur. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:244
translate french day16_choices_209dc845_2:

    # "{i}Your kiss is long and passionate and nearly takes [r_name]'s breath away. Though you are in a secluded spot, anybody could see you. But you both clearly don't care about that."
    "{i}Vous échangez un long et passionné baiser qui coupe le souffle de [r_name]. Bien que vous soyez dans un endroit isolé, n'importe qui pourrait vous voir, mais vous ne vous en souciez pas."

# game/day16.rpy:287
translate french day16_choices_882738fb:

    # p "So Nia, tell me a little about yourself."
    p "Alors, Nia, parle-moi un peu de toi."

# game/day16.rpy:321
translate french day16_choices_2ea44e6e:

    # n "Yeah, and I know Rebeca very well."
    n "Oui et je connais très bien Rebeca."

# game/day16.rpy:461
translate french day16_choices_1b229ea6:

    # "{i}When you walk to the address Rebeca gave you, she's already outside waiting for you."
    "{i}Quand vous marchez jusqu'à l'adresse que Rebeca vous as donnée, elle vous attend dehors."

# game/day16.rpy:469
translate french day16_choices_be9efabc:

    # p "{i}(Knowing a bit about her current body of work, I can guess what particular form she's interested in.)"
    p "{i}(Connaissant un peu son travail, je peux deviner la forme particulière qui l'intéresse.)"

# game/day16.rpy:483
translate french day16_choices_378d2827:

    # "{i}When you're halfway back to the studio, Rebeca suddenly stops."
    "{i}Quand vous êtes à mi-chemin du retour, Rebeca s'arrête soudainement."

# game/day16.rpy:490
translate french day16_choices_dc7928c0:
    ...
    "{i}Prenant garde de ne pas vous faire prendre, vous suivez Rebeca jusqu'à un endroit isolé, entre plusieurs gros rochers. Elle est déjà déshabillée lorsque vous arrivez..."

# game/day16.rpy:494
translate french day16_choices_a1ab4375:

    # p "{i}(Let it flow, girl... Damn what a sight.)"
    p "{i}(Laisse couler ma fille... Quel beau spectacle !)"

# game/day16.rpy:527
translate french day16_choices_fd211acc:

    # "{i}Rebeca returns after a short while and looks relieved."
    "{i}Rebeca revient au bout d'un moment et semble soulagée."

# game/day16.rpy:555
translate french day16_choices_c428e0ed:

    # "{i}When Rebeca is satisfied, she suddenly stops massaging your dick and digs out some tools, presumably to make the mold. You start to doze off again from the heat."
    "{i}Quand Rebeca est satisfaite, elle arrête soudainement de masser votre bite et sort quelques outils, probablement pour faire le moule. Vous recommencez à somnoler à cause de la chaleur."

# game/day16.rpy:557
translate french day16_choices_858df364:

    # "{i}Almost subconsciously, you feel some thick, cold liquid being poured over your crotch, which quickly hardens. Rebeca whistles an inane tune while she works."
    "{i}Presque inconsciemment, vous ressentez un liquide épais et froid se répandre sur votre entrejambe, qui durcit rapidement. Rebeca siffle un air stupide pendant qu'elle travaille."

# game/day16.rpy:569
translate french day16_choices_c41e60f5:

    # "{i}When you enter her, she's already wet. You penetrate her deeply and quickly establish a rhythm."
    "{i}Quand vous entres enfin en elle, elle est déjà mouillée. Vous la pénétrez profondément et vous établissez rapidement un rythme."

# game/day16.rpy:572
translate french day16_choices_a6080212:

    # "{i}Encouraged by her words, you pound her even deeper. The studio is filled with the wet sounds of your fucking and Rebeca's hoarse moans."
    "{i}Encouragée par ses paroles, vous la pilonnez encore plus fort. Le studio est rempli des sons humides de votre accouplement et des gémissements rauques de Rebeca."

# game/day16.rpy:574
translate french day16_choices_e0792702:

    # "{i}As you change positions, Rebeca's ass bounces against your pelvis. You slap it repeatedly."
    "{i}Quand vous changez de position, le cul de Rebeca rebondit contre votre bassin et vous le giflez à plusieurs reprises."

# game/day16.rpy:679
translate french day16_evening_choices_5112ee45:

    # p "Yes, it's a restaurant built inside a natural cave. On top of that, I read that the food is also excellent."
    p "Oui, c'est un restaurant construit dans une grotte naturelle. De plus, j'ai lu que la nourriture est excellente."

# game/day16.rpy:690
translate french day16_evening_choices_0f19bedc:

    # "{i}After you're both seated, you order some wine."
    "{i}Après vous être assis, vous commandez du vin."

# game/day16.rpy:718
translate french day16_evening_choices_ba2cfc92:

    # b "The trout for me, please."
    b "La truite pour moi, s'il vous plaît."

# game/day16.rpy:720
translate french day16_evening_choices_dbc36a0e:

    # "{i}The conversation is a bit awkward after that, but the mood lightens as soon as the food arrives."
    "{i}La conversation est ensuite un peu gênante, mais l'ambiance se détend dès que le repas arrive."

# game/day16.rpy:824
translate french day16_b_restaurant_choices_soft_a9b82779:

    # "{i}After both finishing your dessert, you're ready to leave."
    "{i}Après avoir fini votre dessert, vous êtes prêts à partir."

# game/day16.rpy:867
translate french day16_b_restaurant_choices_soft_d2ae686c:

    # "{i}After another bout of silence, the food finally arrives."
    "{i}Après un autre silence, la nourriture arrive enfin."

# game/day16.rpy:874
translate french day16_b_restaurant_choices_soft_11bb89d8:

    # "{i}Despite her earlier protests, [b_name] clearly enjoys the food before her."
    "{i}Malgré ses protestations antérieures, [b_name] apprécie clairement la nourriture qui lui est servie."

# game/day16.rpy:936
translate french day16_b_restaurant_choices_soft_350ff58a:

    # "{i}The air is still warm outside, and there's a slight sea breeze. At first, you walk in silence along the shoreline, the sea softly splashing against your ankles."
    "{i}L'air est encore chaud et il y a une légère brise marine. Au début, vous marchez en silence le long du rivage, la mer éclaboussant doucement vos chevilles."

# game/day16.rpy:941
translate french day16_b_restaurant_choices_soft_c4bf5da9:

    # "{i}[l_name] is silent after this exchange. A few times, it looks like she's trying to say something but thinks better of it."
    "{i}[l_name] se tait après cet échange. Parfois, on dirait qu'elle essaie de dire quelque chose, mais qu'elle préfère y réfléchir."

# game/day16.rpy:1035
translate french day16_b_restaurant_choices_soft_2daad4de:

    # p "When you think you're losing momentum, think of dirty things."
    p "Quand tu penses que tu perds ton élan, pense à des choses sales."

# game/day16.rpy:1056
translate french day16_b_restaurant_choices_soft_888962a9:

    # p "After all those kisses, I'd move back to your nipples and teasingly lick them while you finger yourself. When you're nearing your orgasm, I'd suck on them, sending you over the edge and making you cum so hard."
    p "Après tous ces baisers, je retournerais à tes tétons et je les lécherais en te taquinant pendant que tu te doigtes. Quand tu approcheras de l'orgasme, je les sucerais, je t'enverrais au bord et te ferais jouir si fort."

# game/day16.rpy:1070
translate french day16_b_restaurant_choices_soft_8d0c9317:
...
# game/day16.rpy:956
translate french day16_b_restaurant_choices_soft_d1f5e97f:

    # p "Relax, dear sis, I was just teasing you."
    p "Détendez-vous, chère sœur, je vous taquinais."

# game/day16.rpy:958
translate french day16_b_restaurant_choices_soft_83cf7ebc:
