# TODO: Translation updated at 2024-01-08 22:47
...
translate turkish strings:
    ...
    new "Güncellemeler yüklendi. Program newden başlatılacaktır."
    ...
    old "Reload"
    new "yenidenden Yükle"

    # renpy/common/_errorhandling.rpym:634
    old "Reloads the game from disk, saving and restoring game state if possible."
    new "Oyunu diskten newden yükler, mümkünse oyun durumunu kaydeder ve geri yükler."
    ...
    new "Kod ayrıştırma işlemi başarısız newu."
# TODO: Translation updated at 2024-11-29 09:54
...
translate turkish strings:
    ...
    new "Daha fazla geçiş eklemek için director.transitions dosyasını özelleştirin."

    # renpy/common/00director.rpy:1846
    old "Customize director.audio_channels to add more channels."
    new "Daha fazla kanal eklemek için director.audio_channels dosyasını özelleştirin."
    ...
    new "kendi kendine seslendirme etkinleştirme"
    ...
    new "pano seslendirme etkinleştirme"
    ...
    new "(temiz tutulan baloncuklar)"

    # renpy/common/00translation.rpy:63
    old "Translation identifier: [identifier]"
    new "Çeviri tanımlayıcısı: [tanımlayıcı]"
    ...
    new "Oyun verilerini indirmek için hazırlanıyor."
