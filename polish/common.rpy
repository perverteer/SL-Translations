translate polish strings:
    ...
    new "Na pewno chce nadpisać ten zapis?"

    # renpy/common/00gui.rpy:385
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Wczytując utracisz niezapisany postęp. \nNa pewno chcesz to zrobić?"
    ...
    new "Jesteś pewny, że chcesz wrócić do głównego menu?\nUtracisz niezapisany postęp."
    ...
    new "Rozpocząć pomijanie?"

    # renpy/common/00gui.rpy:390
    old "Are you sure you want to skip to the next choice?"
    new "Jesteś pewny, że chcesz przeskoczyć do następnego wyboru?"

    # renpy/common/00gui.rpy:391
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "Jesteś pewny, że chcesz pominąć niewidziane dialogi, do następnego wyboru?"
    ...
    new "Ten program zawiera oprogramowanie pod wieloma licencjami, w tym MIT License i GNU General Public License. Pełna lista oprogramowania, w tym odnośniki do pełnego kodu źródłowego, można znaleźć {a=https://www.renpy.org/l/license}tutaj{/a}."
    ...
    new "Zdjęcie [index] z [count] zablokowanych."
